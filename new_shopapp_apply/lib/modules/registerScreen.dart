...
import 'package:new_news_app_apply/cubit/signInCubit.dart';
                      ...
                      [
                        Row(
                          children: [
                            ...
                            Text('new_news_app_apply',style: TextStyle(fontSize: 20),),
                            Spacer(),
                            IconButton(
                                onPressed: ()
                                {
                        ...
                        Text('Create a new_news_app_apply account',style: TextStyle(fontSize: 20,),),
                        SizedBox(height: 30,),
                        defaultFormField(
                            context: context,
                            controller: name,
